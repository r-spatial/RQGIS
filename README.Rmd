...
- test open_help and iron out bugs. Additionally, automatically construct a helpfile if no documentation is availabe on the Internet (-> if Python web scraping "Error" == TRUE, construct html file)
