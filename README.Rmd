...
| R CMD check   | <a href="https://cran.r-project.org/web/checks/check_results_RQGIS.html"><img border="0" src="http://www.r-pkg.org/badges/version/RQGIS" alt="CRAN version"></a> | [![OLD_LTR_Linux=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=OLD_LTR_Linux=true&label=QGIS OLD_LTR (2.14.20)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) \
[![LTR_Linux=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=LTR_Linux=true&label=QGIS LTR (2.18.14)&branch=master)](https://travis-ci.org/jannes-m/RQGIS)   \
[![NIGHTLY_Linux=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=NIGHTLY_Linux=true&label=QGIS NIGHTLY (2.99)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) | [![OLD_LTR_mac=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=OLD_LTR_mac=true&label=QGIS LTR (2.14.20)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) \
[![LTR_mac=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=LTR_mac=true&label=QGIS DEV (2.18.14)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) | <a href="https://ci.appveyor.com/project/jannes-m/RQGIS"><img src="https://ci.appveyor.com/api/projects/status/github/jannes-m/RQGIS?svg=true" alt="Build status"></a> |
...
[https://rjournal.github.io/archive/2017/RJ-2017-067/index.html](https://rjournal.github.io/archive/2017/RJ-2017-067/index.html)
