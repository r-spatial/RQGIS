...
Please update to version 1.2 of `reticulate`.
...
| R CMD check   | <a href="https://cran.r-project.org/web/checks/check_results_RQGIS.html"><img border="0" src="http://www.r-pkg.org/badges/version/RQGIS" alt="CRAN version"></a> | [![LTR_Linux=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=LTR_Linux=true&label=QGIS LTR (2.14.20)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) \
[![DEV_Linux=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=DEV_Linux=true&label=QGIS DEV (2.18.14)&branch=master)](https://travis-ci.org/jannes-m/RQGIS)   | [![LTR_mac=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=LTR_mac=true&label=QGIS LTR (2.14.20)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) \
