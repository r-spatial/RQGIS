...
| R CMD check   | <a href="https://cran.r-project.org/web/checks/check_results_RQGIS.html"><img border="0" src="http://www.r-pkg.org/badges/version/RQGIS" alt="CRAN version"></a> | [![qgis218=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=qgis218=true&label=QGIS LTR (2.18.17)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) | [![OLD_LTR_mac=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=OLD_LTR_mac=true&label=QGIS LTR (2.14.14)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) \
