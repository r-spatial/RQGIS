...
# Installation 
Before installing RQGIS, go to [http://trac.osgeo.org/osgeo4w/](http://trac.osgeo.org/osgeo4w/), download the latest OSGeo4W and make sure that following components will be installed (advanced settings):
...
```{r ger_download, warning = FALSE, error = FALSE, message = FALSE, cache = TRUE}
<<<<<<< HEAD
...
=======
```{r, warning = FALSE, error = FALSE, depends = "ger_download", cache = TRUE}
library("rgdal")
