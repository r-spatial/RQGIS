...
- Rewrite check_apps and set_env in such a way that the user might specify root, qgis_prefix_path, python_plugins himself (at least for UNIX)
- rewrite run_qgis documentation
- set GRASS_REGION_CELLSIZE_PARAMETER automatically
- test open_help and iron out bugs of third-party providers (Taudem, OTB, etc.). Additionally, automatically construct a helpfile if no documentation is availabe on the Internet (-> if Python web scraping "Error" == TRUE, construct html file)
