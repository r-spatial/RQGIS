...
Please use the QGIS LTR **2.18** since **RQGIS** does not support QGIS 3!!
But [RQGIS3](https://github.com/jannes-m/RQGIS3) does.
So far **RQGIS3** should already work under Windows and Linux, please report back any issues under <https://github.com/jannes-m/RQGIS3>.
