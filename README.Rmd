...
# Installation 
Before installing RQGIS, download the latest OSGeo4W from [http://trac.osgeo.org/osgeo4w/](http://trac.osgeo.org/osgeo4w/), download and make sure that following components will be installed on your system (advanced settings):
