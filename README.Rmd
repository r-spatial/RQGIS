...
[![NIGHTLY_Linux=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=NIGHTLY_Linux=true&label=QGIS NIGHTLY (2.99)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) | [![LTR_mac=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=LTR_mac=true&label=QGIS LTR (2.14.20)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) \
[![DEV_mac=true Status](https://badges.herokuapp.com/travis/jannes-m/RQGIS?env=DEV_mac=true&label=QGIS DEV (2.18.14)&branch=master)](https://travis-ci.org/jannes-m/RQGIS) | <a href="https://ci.appveyor.com/project/jannes-m/RQGIS"><img src="https://ci.appveyor.com/api/projects/status/github/jannes-m/RQGIS?svg=true" alt="Build status"></a> |
