...
[![Last-changedate](https://img.shields.io/badge/last%20change-2017--11--19-yellowgreen.svg)](/commits/master)
...
this incredibly powerful geoprocessing environment to the R
console.
...
same using `sp::coordinates()`. To harness the real power of integrating
R with a GIS, we will present a second, more complex example. Yet to
come in the form of a paper…
