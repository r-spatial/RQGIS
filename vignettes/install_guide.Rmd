...
3. After expanding the command line utilities, we choose several commandline tools such as gdal and python-core:

<center>
  <img src="D:\programming\R\RQGIS\RQGIS\figures\05_command_line_utilties.PNG" width="50%" height="50%">
</center>

Additionally, we choose the Desktop-GIS GRASS 6 & 7, the Orfeo Toolbox, the latest QGIS release and SAGA.
