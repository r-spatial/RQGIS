...
you install QGIS from the built-in Software managers of your OS, you will most 
likely get a rather old QGIS version as these repositories only getting updated 
quite sparsely. For other Linux builds, please see respective tutorials for 
yourself.

To help you with the instructions provided at the QGIS website, here is 
...
3. Move to the end of the document and add the following lines:   
  ...
  Ubuntu build name which is "Xenial Xerus" for Version 16.04. Save it and
  exit. 
...
repositories. Everytime you are running `sudo apt-get update` Ubuntu checks for
new QGIS updates. 
